...
from model_variants.BrainModel_neurons import Neurons, BrainModel, PriorNetwork, BrainDiffusionPrior, RidgeRegression, CLIPProj, TextDrivenDecoder, TextDecoder, MotionProj
    ...
    with torch.no_grad(), torch.cuda.amp.autocast(dtype=torch.float16):
        for batch in tqdm(test_dl, desc='batches'):
            ...
            vae_embeds = model.text_seg_dec(rearrange(motion_embeds, "b f n c -> (b f) n c"),
                                            ...
                                            is_seg=False)
            # print(f"\033[91m {vae_embeds.shape} \033[0m")
