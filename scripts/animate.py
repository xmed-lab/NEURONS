...
def main(args):
    *_, func_args = inspect.getargvalues(inspect.currentframe())
    ...
    for model_idx, model_config in enumerate(config):
        ...
        unet = UNet3DConditionModel.from_pretrained_2d(args.pretrained_model_path, cache_dir="./pretrained_weights", subfolder="unet", unet_additional_kwargs=OmegaConf.to_container(inference_config.unet_additional_kwargs)).cuda()
